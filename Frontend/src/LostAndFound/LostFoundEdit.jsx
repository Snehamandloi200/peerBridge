    ...
    >
      ...
      >
        ...
        <form className="row g-4" onSubmit={handleSubmit}>
          ...
          {[
            { label: "Item itemName", name: "itemName", type: "text", placeholder: "Enter item name" },
            ...
            >
              ...
              <input
                ...
                placeholder={lostAndFound.status}
                name="status"
          ...
          >
            ...
            <input
              type="text"
              className="form-control shadow-sm"
              placeholder={lostAndFound.location}
              name="location"
          ...
          >
            ...
            <textarea
              className="form-control shadow-sm"
              rows="3"
              placeholder={lostAndFound.description}
              name="description"
